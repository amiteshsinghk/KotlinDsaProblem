...
* */
        var swapList = LinkedList<Int>()
    swapList.push(5).push(4).push(3).push(2).push(1)
    println("Swape List before :: $swapList :: head =${swapList.head}")
    var l1 =swapList.swapLists(swapList.head)
...
* */
    ...
    var removeItemList = LinkedList<Int>()
    removeItemList.push(5).push(4).push(3).push(2).push(1)
    println(" List before remove nth item from end :: $removeItemList :: head =${removeItemList.head}")
    var afterRemove= removeItemList.removeNthFromEnds(removeItemList.head,2)
